...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from coding_agent.agents.fork import ForkError, build_forked_messages
        from coding_agent.agents.parser import AgentDef
        from coding_agent.agents.tool_filter import resolve_agent_tools
        from coding_agent.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from coding_agent.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from coding_agent.agents.fork import ForkError, build_forked_messages
        from coding_agent.agents.parser import AgentDef
        from coding_agent.agents.tool_filter import build_teammate_tools
        from coding_agent.agent import Agent as AgentClass
        from coding_agent.conversation import ConversationManager
        from coding_agent.permissions import DangerousCommandDetector, PathSandbox, PermissionChecker, PermissionMode, RuleEngine
        from coding_agent.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from coding_agent.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from coding_agent.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from coding_agent.client import create_client
