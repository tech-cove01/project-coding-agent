...
from coding_agent.permissions.dangerous import DangerousCommandDetector, is_safe_command
from coding_agent.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from coding_agent.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".coding_agent/plans/" in target_path
        try:
