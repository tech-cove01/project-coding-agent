...
def build_cli_command(
    ...
    env_parts = [
        f"CODING_AGENT_TEAM_NAME={team_name}",
        f"CODING_AGENT_TEAMMATE_NAME={teammate_name}",
    ]
    if mailbox_dir:
        env_parts.append(f"CODING_AGENT_MAILBOX_DIR={mailbox_dir}")
