...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None, project_root: str | None = None) -> ToolRegistry:
    ...
    from coding_agent.tools.glob import Glob
    from coding_agent.tools.grep import Grep
    ...
    registry.register(WriteFile(file_cache=file_cache, file_history=file_history, file_state_cache=file_state_cache, project_root=project_root))
    registry.register(EditFile(file_cache=file_cache, file_history=file_history, file_state_cache=file_state_cache, project_root=project_root))
