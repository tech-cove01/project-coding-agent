...
from coding_agent.conversation import ConversationManager, Message, ToolResultBlock, estimate_tokens
from coding_agent.serialization import build_messages
...
SESSION_SUBDIR = ".coding_agent/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from coding_agent.tools.base import StreamEnd, StreamEvent, TextDelta
