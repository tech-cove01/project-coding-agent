...
from coding_agent.skills.parser import SkillDef, substitute_arguments
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from coding_agent.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
