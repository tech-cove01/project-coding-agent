...
PROJECT_AGENTS_DIR = ".coding_agent/agents"
USER_AGENTS_DIR = "~/.coding_agent/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("coding_agent.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from coding_agent.agents.parser import parse_frontmatter, _validate_agent_meta
