...
def build_teammate_tools(
    ...
    from coding_agent.tools.send_message import SendMessageTool
    from coding_agent.tools.task_create import TaskCreateTool
    from coding_agent.tools.task_get import TaskGetTool
    from coding_agent.tools.task_list import TaskListTool
    from coding_agent.tools.task_update import TaskUpdateTool
